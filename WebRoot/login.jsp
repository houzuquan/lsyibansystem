...
<link rel="stylesheet" type="text/css"
	href="Public/js/alert/easydialog.css" />
<script src="Public/js/alert/easydialog.min.js" type="text/javascript"
	charset="utf-8"></script>
<script src="Public/js/login.js" type="text/javascript" charset="utf-8"></script>
<script src="Public/js/function.js" type="text/javascript"
	charset="utf-8"></script>
...
<body>
	<form action="Login" method="post" id="loginBox"
		onsubmit="checkFormSubmit(this);return false;">
		<h1>用户登陆</h1>
		<input type="text" name="stuId" id="username" value=""
			placeholder="用户名/邮箱" /> <input type="password" name="pass"
			id="password" value="" placeholder="密码" />
		<!--
            	作者：1184511588@qq.com
            	时间：2016-10-08
            	描述：暂时不用验证码-->
		<input type="text" name="yzmText" id="yzmText" value=""
			placeholder="验证码" /> <img src="./Yzm" id="yzm" alt="点击刷新验证码"
			title="点击刷新验证码" /> <input type="submit" value="登陆" />
		<p class="fen">
