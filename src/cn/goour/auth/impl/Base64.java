...
public class Base64 implements IEncryptNoKey
{
	...
	@Override
	public byte[] Encryption(byte[] byteData) throws Exception
	{
	...
	@Override
	public byte[] Decryption(byte[] byteData) throws Exception
	{
		// TODO: Implement this method
		/* If we received a null argument, exit this method. */
        if (byteData == null) { throw new IllegalArgumentException("byteData cannot be null"); }
